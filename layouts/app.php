...
<head>
    ...
    <link rel="sidebar" href="sidebaranimation.css"> <!-- 引入外部CSS文件 -->
    <script src="sidebaranimation.js"></script> <!-- 引入外部JavaScript文件 -->
    ...
    <link rel="stylesheet" href="Addandeditstyles.css">
    <script src="Addandeditscripts.js"></script>

        ...
        <div class="modal-content">
            ...
            <form id="food_form_r" action="{{ route('calendar.update') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="food-name"><i class="fas fa-carrot mr-2"></i>食物名稱:</label>
                        <input type="text" class="form-control border-success" id="food_name_r" name="food_name"
                               required>
                    </div>
                    <div class="form-group">
                        <label for="category"><i class="fas fa-th-large mr-2"></i>類別:</label>
                    ...
                    <div class="form-group">
                        <label for="storage-location"><i class="fas fa-map-marker-alt mr-2"></i>存放位置:</label>
                        <input type="text" class="form-control border-success" id="storage_location_r"
                               name="storage_location" placeholder="例如: 冰箱、櫥櫃">
                    </div>
                    <div class="form-group">
                        <label for="purchase-date"><i class="fas fa-calendar-alt mr-2"></i>購買日期:</label>
                        <input type="date" class="form-control border-success" id="purchase_date_r" name="purchase_date"
                               value="" required>
                    </div>
                    <div class="form-group">
                        <label for="quantity"><i class="fas fa-sort-numeric-up mr-2"></i>數量:</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <button type="button" class="btn btn-success text-white" id="decrease_quantity_r">-
                                </button>
                            </div>
                            <input type="number" class="form-control text-center border-success" id="quantity_r"
                                   name="quantity" value="1" min="1">
                            <div class="input-group-append">
                                <button type="button" class="btn btn-success text-white" id="increase_quantity_r">+
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="price"><i class="fas fa-dollar-sign mr-2"></i>金額:</label>
                        <input type="number" class="form-control border-success" id="price_r" name="price" required>
                    </div>
                    <div class="form-group">
                        <label for="expiry-date"><i class="fas fa-calendar-check mr-2"></i>有效期限:</label>
                        <input type="date" class="form-control border-success" id="expiry_date_r" name="expiry_date"
                               value="" required>
                    </div>
                    <div class="form-group">
                        <label for="food-status"><i class="fas fa-info-circle mr-2"></i>食物狀態:</label>
                        <select class="form-control border-success" id="food_status_r" name="food_status">
                            <option value="未過期" selected>未過期</option>
                            <option value="過期">過期</option>
                            <option value="完成">完成</option>
                        </select>
                ...
                <div class="modal-footer bg-light">
                    <button type="submit" form="food_form_r" class="btn btn-success btn-block">

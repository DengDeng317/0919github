            ...
            <div class="modal-body">
                <form id="food-form" action="{{ route('calendar') }}" method="post">
                                ...
                                <div class="dropdown w-100">
                                    ...
                                    <button class="btn btn-outline-success dropdown-toggle w-100" type="button"
                                        ...
                                        <img
                                            ...
                                            style="max-width: 50px;" alt="{{ $getFoodCategory->first()->name }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control border-success" id="expiry-date" name="expiry-date" required>
                    </div>
                </form>
            </div>
